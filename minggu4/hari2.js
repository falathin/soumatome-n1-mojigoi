...
const kosakata_m4h2 = [
  // --- KANJI 気 ---
  {
    ...
    penjelasan: 'Sisa air yang masih menempel pada suatu benda (misalnya setelah dicuci).',
  ...
  },
  {
    ...
    penjelasan: 'Tanda-tanda adanya orang. Sering dipakai untuk bilang tempatnya sepi (tidak ada orang).',
  ...
  },
  {
    ...
    penjelasan: 'Rasa merinding atau menggigil, biasanya saat mau sakit atau ketakutan.',
  ...
  },
  {
    ...
    penjelasan: 'Sifat atau watak asli seseorang yang sudah kita kenal dekat.',
  ...
  },
  {
    ...
    furigana: 'しょうき',
    arti: 'Waras / Sadar',
    penjelasan: 'Kondisi sadar dan waras. Sering dipakai untuk mengkritik tindakan nekat/tidak masuk akal.',
  ...
  },
  {
    ...
    furigana: 'きあい',
    arti: 'Semangat / Tekad',
    penjelasan: 'Semangat, energi, dan tekad penuh sebelum melakukan sesuatu yang penting.',
  ...
  },
  {
    ...
    furigana: 'きなが（な）',
    arti: 'Sabar / Santai',
    penjelasan: 'Sifat penyabar, santai, dan tidak terburu-buru.',
  ...
  // --- KANJI 出 ---
  {
    ...
    penjelasan: 'Mengirim atau memajang barang untuk acara pameran atau lelang.',
  ...
  },
  {
    ...
    penjelasan: 'Kabur meninggalkan rumah karena suatu masalah.',
  ...
  },
  {
    ...
    furigana: 'しゅっさん',
    arti: 'Melahirkan',
    penjelasan: 'Proses ibu melahirkan seorang bayi.',
  ...
  },
  {
    ...
    furigana: 'しゅっせい',
    arti: 'Kelahiran',
    penjelasan: 'Kata resmi untuk "kelahiran", biasanya dipakai di dokumen atau data statistik.',
  ...
  },
  {
    ...
    penjelasan: 'Membuat dan mengeluarkan soal untuk bahan ujian.',
  ...
  },
  {
    ...
    penjelasan: 'Pasukan atau tim (seperti polisi/medis) yang dikerahkan ke lokasi kejadian.',
  ...
  },
  {
    ...
    penjelasan: 'Berangkat dan tiba di kantor untuk bekerja.',
  ...
  },
  {
    ...
    penjelasan: 'Naik jabatan atau sukses dalam karier pekerjaan.',
  ...
  // --- KANJI 下 ---
  {
    ...
    penjelasan: 'Bumbu dasar yang dilumuri ke bahan makanan sebelum dimasak agar meresap.',
  ...
  },
  {
    ...
    furigana: 'したじ',
    arti: 'Dasar / Fondasi',
    penjelasan: 'Dasar atau fondasi, seperti krim alas bedak (makeup) atau kemampuan dasar dalam belajar.',
  ...
  },
  {
    ...
    penjelasan: 'Kondisi yang mulai mereda (seperti wabah) atau sudah tidak populer lagi (seperti tren).',
  ...
  // --- KANJI 上 ---
  {
    ...
    penjelasan: 'Kondisi yang mulai naik atau membaik, seperti nilai akademik atau perputaran ekonomi.',
  ...
  },
  {
    ...
    penjelasan: 'Hasil yang berhasil melebihi target atau perkiraan.',
  ...
  },
  {
    ...
    penjelasan: 'Pikiran melayang atau melamun karena tidak fokus pada apa yang ada di depan mata.',
  ...
  },
  {
    ...
    penjelasan: 'Menimpa (overwrite) data lama dengan file atau data yang baru di komputer.',
  ...
  // --- KANJI 回 ---
  {
    ...
    penjelasan: 'Kendaraan umum yang sedang kosong (tidak melayani penumpang) untuk kembali ke garasi.',
  ...
  },
  {
    ...
    penjelasan: 'Memberikan jawaban resmi, biasanya untuk survei atau kuesioner.',
  ...
  },
  {
    ...
    furigana: 'まわりみち',
    arti: 'Jalan memutar',
    penjelasan: 'Memilih rute jalan yang memutar (biasanya karena macet atau jalan ditutup).',
  ...
  },
  {
    ...
    penjelasan: 'Mengambil jalan yang membuat jarak dan waktu tempuh menjadi lebih jauh dari rute biasanya.',
  ...
  },
  {
    ...
    penjelasan: 'Menunda suatu pekerjaan agar bisa dikerjakan belakangan.',
