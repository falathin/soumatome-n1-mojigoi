...
const kosakata_m6h6 = [
  ...
  // ==========================================
  {
    ...
    penjelasan: 'Kata 辺り (atari) di sini merujuk pada lokasi fisik atau area di sekitar suatu titik tertentu. Maknanya sama dengan 辺 (hen). Digunakan untuk menunjuk lingkungan, wilayah sekitar, atau tempat yang berdekatan.',
  ...
  },
  {
    ...
    penjelasan: 'Selain untuk tempat, 辺り (atari) juga bisa digunakan untuk waktu. Maknanya adalah "sekitar waktu tersebut" atau perkiraan kasar kapan sesuatu akan terjadi, mirip dengan penggunaan ごろ (goro).',
  ...
  },
  {
    ...
    penjelasan: 'Secara harfiah berarti tiupan angin yang menerpa dengan kuat. Namun secara kiasan, ungkapan ini sangat sering dipakai untuk menggambarkan posisi seseorang yang sedang diserang oleh kritik, tekanan sosial, atau penilaian negatif yang bertubi-tubi dari orang lain.',
  ...
  },
  {
    ...
    penjelasan: 'Merupakan ungkapan untuk mendeskripsikan kepribadian. Seseorang yang "人当たりがいい" berarti mereka memberikan kesan pertama yang sangat baik, bersikap lembut, sopan, dan mudah bergaul sehingga orang lain merasa nyaman berinteraksi dengannya.',
  ...
  },
  {
    ...
    penjelasan: 'Sebuah idiom di mana 当たり bermakna "sasaran" atau "perkiraan". "当たりをつける" berarti membuat estimasi, menduga, atau menebak-nebak (見当をつける) suatu hal (seperti angka, lokasi, atau alasan) sebelum memastikannya.',
  ...
  },
  {
    ...
    penjelasan: 'Kata 大当たり (ooatari) secara harfiah berarti "tepat mengenai sasaran dengan telak". Dalam konteks hiburan atau bisnis, ini merujuk pada kesuksesan finansial yang masif (大成功) atau produk yang meledak di pasaran.',
  ...
  },
  {
    ...
    penjelasan: 'Digunakan ketika seseorang beruntung mendapatkan sesuatu dari hasil pengacakan, seperti memenangkan lotre, undian (当選する), atau mendapat hadiah. Antonimnya adalah はずれる (meleset/kalah).',
  ...
  // ==========================================
  {
    ...
    penjelasan: 'Makna paling dasar dari 筋 (suji), yaitu anatomi tubuh berupa otot, urat, atau tendon yang menggerakkan tubuh manusia maupun hewan.',
  ...
  },
  {
    ...
    penjelasan: 'Merujuk pada jaringan urat atau ikat pada daging hewan yang membuatnya keras atau alot jika dikunyah. Daging seperti ini biasanya butuh direbus lama agar empuk.',
  ...
  },
  {
    ...
    penjelasan: 'Pada konteks tumbuh-tumbuhan, 筋 (suji) merujuk pada serat tanaman yang keras dan memanjang, seperti pada seledri, buncis, atau kacang panjang. Serat ini sering dibuang sebelum dimasak.',
  ...
  },
  {
    ...
    penjelasan: 'Dalam penampakan visual pada kulit manusia, 筋 juga merujuk pada pembuluh darah (vena) kebiruan yang menonjol keluar, terutama pada orang yang kurus, berotot, atau saat sedang marah.',
  ...
  },
  {
    ...
    penjelasan: 'Secara kiasan (idiom), 筋 (suji) merujuk pada bakat bawaan, potensi, atau fondasi pemahaman seseorang terhadap suatu keterampilan (素質). Kalau dibilang "筋がいい", artinya orang tersebut cepat menangkap pelajaran dan punya bakat alami.',
  ...
  },
  {
    ...
    penjelasan: 'Dalam konteks pemikiran, 筋 merujuk pada alur logika atau jalan pikiran. Sesuatu yang "筋が通っている" (suji ga tootte iru) berarti argumen atau alasan tersebut runut, rasional, dan konsisten dari awal hingga akhir (合点がいく).',
  ...
  },
  {
    ...
    penjelasan: 'Mirip dengan alur logika di atas, dalam karya sastra, film, atau teater, 筋 (suji) berarti ringkasan plot atau garis besar jalannya sebuah cerita (あらすじ).',
  ...
  // ==========================================
  {
    ...
    penjelasan: 'Makna fisik dari 先 (saki) adalah "bagian ujung", pucuk, atau titik terdepan dari suatu benda yang memanjang (seperti jari, pensil, ranting).',
  ...
  },
  {
    ...
    penjelasan: 'Dalam konteks arah atau perjalanan, 先 (saki) berarti "bagian depan" (前). Maju ke "saki" berarti terus melangkah maju menjauhi posisi awal.',
  ...
  },
  {
    ...
    penjelasan: 'Dalam konteks suatu proses atau narasi yang terputus, 先 (saki) bermakna "kelanjutan" (続き) atau bagian selanjutnya yang belum disampaikan.',
  ...
  },
  {
    ...
    penjelasan: 'Sebagai keterangan waktu, 先 (saki) sering mengacu pada masa lalu yang berdekatan atau "sebelumnya" (以前). Sesuatu yang terjadi "lebih dulu" dari sekarang.',
  ...
  },
  {
    ...
    penjelasan: 'Berkebalikan dengan poin sebelumnya, dalam konteks "melihat ke depan", 先 (saki) justru bermakna masa depan (将来) atau apa yang akan terjadi nanti di waktu yang belum tiba.',
  ...
  },
  {
    ...
    penjelasan: 'Digunakan untuk urutan tindakan. "先に" (saki ni) berarti melakukan sesuatu lebih awal mendahului tindakan lain, atau mendahului orang lain.',
  ...
  },
  {
    ...
    penjelasan: 'Idiom "先を争う" (saki o arasou) berarti berlomba-lomba atau berdesakan untuk menjadi yang pertama kali melakukan sesuatu atau mencapai suatu tempat, saling mendahului pihak lain.',
  ...
  },
  {
    ...
    penjelasan: 'Akhiran -saki menempel pada kata kerja atau kata benda untuk menunjukkan "lokasi tujuan" atau "pihak penerima". 行き先 = tempat tujuan pergi. 取引先 = pihak klien bisnis. 連絡先 = alamat/nomor kontak tujuan.',
  ...
  // ==========================================
  {
    ...
    penjelasan: 'Makna harfiah dari 道 (michi), yaitu jalan raya, jalur fisik yang dilalui kendaraan atau orang berjalan kaki.',
  ...
  },
  {
    ...
    penjelasan: 'Kiasan untuk suatu proses perjuangan panjang, perjalanan hidup, atau cara yang ditempuh demi mencapai suatu tujuan. Kata "jalan" di sini bermakna rute abstrak kehidupan.',
  ...
  },
  {
    ...
    penjelasan: 'Digabung dengan kata kerja dasar, kata -michi bermakna "kegunaan" atau "metode pemanfaatan" (使う方法). Misalnya 使い道 (cara pakai/fungsi), 逃げ道 (jalan keluar/pelarian).',
  ...
  },
  {
    ...
    penjelasan: 'Idiom yang kental unsur moral. 道 di sini berarti doktrin, moralitas, kewajiban, atau tata krama (道徳). Seseorang yang "人の道に外れる" berarti berbuat sangat keji dan kehilangan hati nurani sebagai manusia.',
  ...
  },
  {
    ...
    penjelasan: 'Kata "その道" (sono michi) bermakna spesialisasi keahlian, profesi, atau suatu bidang ilmu pengetahuan tertentu (分野).',
  ...
  // ==========================================
  {
    ...
    penjelasan: 'Makna harfiah dari 種 (tane), yaitu biji tanaman atau benih yang ditanam di tanah agar tumbuh menjadi tumbuhan.',
  ...
  },
  {
    ...
    penjelasan: 'Di dunia kuliner, terutama sushi, 種 (tane) merujuk pada lauk atau bahan mentah (材料) yang diletakkan di atas nasi. Oleh para koki, ini sering dibalik pelafalannya menjadi "ネタ" (neta).',
  ...
  },
  {
    ...
    penjelasan: 'Secara kiasan, benih/biji (種) dianggap sebagai asal-muasal tumbuhnya sesuatu. "悩みの種" artinya hal atau orang yang terus-menerus menjadi sumber kekhawatiran dan memicu masalah (根源).',
  ...
  },
  {
    ...
    penjelasan: 'Sama seperti bahan sushi, "話の種" (hanashi no tane) berarti pokok bahasan yang membuat percakapan bisa bergulir dan tumbuh (話題). Mirip artinya dengan "ネタ" (neta) untuk obrolan/komedi.',
  ...
  },
  {
    ...
    penjelasan: 'Dalam dunia sihir/sulap, "種" (tane) merujuk pada mekanisme rahasia atau trik tersembunyi (仕掛け) yang membuat sulap itu bisa terjadi. Ungkapan "種も仕掛けもない" berarti "tidak ada trik sulap maupun rekayasa sama sekali".',
